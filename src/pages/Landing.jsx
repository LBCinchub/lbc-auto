...
export default function Landing() {
  ...
  return <div className="lbc-landing"><LandingNav open={navOpen} setOpen={setNavOpen} onSignIn={signIn}/><main><HeroSection onTour={startTour} onSignIn={signIn}/><ProductTour active={tourActive} setActive={setTourActive}/><WorkflowSection/><CapabilityMap/><RolesSection/><ProofSection/><PricingSection/><TrustSection/></main><LandingFooter onSignIn={signIn}/></div>;
}