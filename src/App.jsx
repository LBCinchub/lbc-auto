...
const AuthenticatedApp = () => {
  ...
  const PUBLIC_PATHS = ['/CustomerPortal', '/lbc-customer', '/CustomerDashboard', '/TechPortal', '/lbc-team', '/TechDashboard', '/TechJobView', '/OfficeAssistant', '/landing', '/WebBookingWidget', '/privacy-policy'];
