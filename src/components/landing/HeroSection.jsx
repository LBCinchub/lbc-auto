...
export default function HeroSection({ onTour, onSignIn }) {
  return <section id="hero" className="lp-hero"><div className="lp-container lp-hero-grid">
    <div className="lp-hero-copy"><span className="lp-eyebrow">AUTO REPAIR SHOP MANAGEMENT SOFTWARE</span><h1>Run Your Entire Auto Shop From One Center Control.</h1><p>LBC Auto connects appointments, customers, vehicles, repair orders, estimates, technician work, invoices, diagnostics, and customer communication in one secure shop management system.</p><p className="lp-capability-line">Operations, team management, parts, diagnostics, financials, reporting, customer communication, and AI assistance—connected around every vehicle.</p>
