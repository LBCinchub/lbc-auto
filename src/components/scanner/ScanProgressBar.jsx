...
export default function ScanProgressBar({ scanning, progress, label }) {
  ...
  return (
    <div className="bg-gray-900 border border-fuchsia-500/30 rounded-xl p-3 flex items-center gap-3 animate-in fade-in slide-in-from-top-1 duration-300">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-xs text-fuchsia-400 font-mono font-bold shrink-0 ml-2">{progress}%</span>
        </div>
