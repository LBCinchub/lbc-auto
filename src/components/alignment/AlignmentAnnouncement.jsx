...
const KEY = "v20260728_alignment_brain_workspace";
export default function AlignmentAnnouncement() {
  ...
  return <div className="fixed inset-0 z-[10000] bg-black/80 flex items-center justify-center p-4"><div className="w-full max-w-lg rounded-2xl border border-sky-500/30 bg-gray-950 p-6 shadow-2xl">
    <Ruler className="w-9 h-9 text-sky-400 mb-3" /><h2 className="text-xl font-bold text-white">Enter the LBC Alignment Brain workspace</h2><p className="text-gray-300 mt-2">A dedicated internal console for alignment sessions, reports, legacy machine recovery, and the future retrofit path.</p>
