...
const navItems = [
  ...
  { name: "Diagnostics",   icon: Gauge,           page: "Diagnostics",      color: "from-fuchsia-500 to-pink-600",   light: "bg-fuchsia-50 text-fuchsia-700 border-fuchsia-200", dark: "bg-fuchsia-500/15 text-fuchsia-400 border-fuchsia-500/30", label: "text-fuchsia-400", proOnly: true },
