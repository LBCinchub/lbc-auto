...
export default async function(req) {
  try {
    ...
    if (estimate.status !== "approved") return Response.json({ error: "Only an approved estimate can be converted" }, { status: 409 });
